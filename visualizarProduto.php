...
<?php
    ...
    if(isset($_GET["idProduto"])){
        ...
        //echo "<h1>ID DO PRODUTO: $idProduto</h1>";
        ...
        if($totalProdutos > 0){
            ...
            //Início da div para exibir o carrossel
            echo "<div class='row text-center mb-5'>"; //mb-5 = Margin Bottom
        ...
        die("<div class='alert alert-danger text-center'><p>Não foi possível carregar este produto</p></div>");
    }
